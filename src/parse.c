...
int add_employee(struct dbheader_t *dbhdr, struct employee_t **employees, char *addstring) {
  ...
  int employee_idx = dbhdr->count++;
  strncpy(e[employee_idx].name, name, sizeof(e[employee_idx].name) - 1);
  strncpy(e[employee_idx].address, address, sizeof(e[employee_idx].address) - 1);
  e[employee_idx].hours = atoi(hours);
